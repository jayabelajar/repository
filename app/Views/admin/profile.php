...
<div class="space-y-6 animate-fade-in-up">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 text-center h-full">
                <div class="flex flex-col items-center">
                        ...
                        <div class="w-24 h-24 rounded-2xl bg-gradient-to-tr from-emerald-500 to-teal-400 p-1 shadow-lg shadow-emerald-200">
                            <div class="w-full h-full rounded-xl bg-white flex items-center justify-center">
                                <span class="text-4xl font-bold text-emerald-600 select-none">
                                    <?= strtoupper(substr($admin['nama'] ?? $admin['nama_lengkap'] ?? 'A', 0, 1)) ?>
                                </span>
                            </div>
                        </div>
                    ...
                    <h2 class="mt-5 text-lg font-bold text-slate-800"><?= e($admin['nama'] ?? $admin['nama_lengkap'] ?? 'Admin') ?></h2>
                    <p class="text-sm text-slate-500 bg-slate-100 px-3 py-1 rounded-full mt-2 font-medium">Administrator</p>
                    
                    <div class="mt-6 w-full border-t border-slate-100 pt-6">
                        <div class="text-xs text-slate-400 uppercase tracking-wider font-semibold mb-3">Informasi Login</div>
                        
                        <div class="flex items-center justify-center gap-2 text-slate-600 text-sm mb-2">
                            <svg class="w-4 h-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                            <span class="font-medium font-mono"><?= e($admin['username'] ?? '-') ?></span>
                        </div>
        ...
        <div class="lg:col-span-2">
            <div class="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 md:p-8">
                ...
                <form action="<?= $base ?>/admin/profile" method="POST" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="nama_lengkap" value="<?= e($admin['nama'] ?? $admin['nama_lengkap'] ?? '') ?>" required 
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="username" value="<?= e($admin['username'] ?? '') ?>" 
                                       class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none transition-all text-sm">
                            </div>
                        </div>
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <button type="button" onclick="togglePassword()" class="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-400 hover:text-slate-600 focus:outline-none cursor-pointer" title="Lihat Password">
