            ...
            <div class="px-6 py-4 border-t border-slate-100 bg-slate-50/30 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm">
                ...
                <div class="flex gap-1.5">
                    <?php 
                        ...
                        // Tombol Sebelumnya
                        if ($page > 1): ?>
                            <a href="<?= $base ?>/mahasiswa/activity?page=<?= $page - 1 ?>" class="w-8 h-8 flex items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-500 hover:bg-slate-50 hover:text-emerald-600 transition-colors">
                        ...
                        for ($p = $start; $p <= $end; $p++): 
                    ?>
                        <a href="<?= $base ?>/mahasiswa/activity?page=<?= $p ?>" 
